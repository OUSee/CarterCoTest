  ...
  var Yale = {
    ...
    Basic: {
      ...
      ylMobileMenu: function () {
        ...
        $(".yl-mobile_menu_wrap").on("click", function () {
          $("body").toggleClass("mobile_menu_overlay_on");
        });
        $(".yl-mobile-main-navigation").on("click", function () {
          $(".yl-mobile_menu_wrap").toggleClass("mobile_menu_on");
        });
